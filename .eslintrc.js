...
module.exports = {
  "extends": ["airbnb"],
  /**
   * The following rules overide styles rules by airbnb so that we can use prettier auto formating.
   */
  rules: {
    /**
    ...
    'padded-blocks': ['off', { blocks: 'never', classes: 'never', switches: 'never' }],
